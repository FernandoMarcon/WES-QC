...
wget -nc -P data/ref $REF_URL/$REF.fa
wget -nc -P data/ref $REF_URL/$REF.fa.fai
wget -nc -P data/ref $REF_URL/$REF.dict

CRAM
CRAM_URL="http://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/1000_genomes_project/data/CEU/${SAMPLE}/exome_alignment"
CRAM="${SAMPLE}.alt_bwamem_GRCh38DH.20150826.CEU.exome.cram"

echo "Downloading CRAM/CRAI files..."
wget -nc -P data/cram $CRAM_URL/$CRAM
wget -nc -P data/cram $CRAM_URL/$CRAM.crai